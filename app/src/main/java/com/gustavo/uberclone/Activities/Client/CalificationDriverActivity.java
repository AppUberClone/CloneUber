...
import com.gustavo.uberclone.Activities.Driver.CalificationClientActivity;
...
public class CalificationDriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRatingBar = findViewById(R.id.ratinbarCalification);
    ...
    private void calificate() {
        if (mCalification > 0){
            ...
            mHistoryBookingProvider.getHistoryBooking(mHistoryBooking.getIdHistoryBooking()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull  DataSnapshot snapshot) {
                    if (snapshot.exists()){
                         mHistoryBookingProvider.updateCalificationDriver(mHistoryBooking.getIdHistoryBooking(), mCalification);
